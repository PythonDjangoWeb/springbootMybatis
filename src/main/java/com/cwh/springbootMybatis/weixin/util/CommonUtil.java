...
import com.cwh.springbootMybatis.weixin.service.serviceImpl.AccessTokenServiceImpl;
...
//	public final static String token_url = "https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=APPID&secret=APPSECRET";
	...
	public  Token getToken(String appid, String appsecret) {
		...
		AccessTokenService accessTokenService =(AccessTokenService)ContextUtils.getBean("accessTokenServiceImpl") ;
...
//	//	log.info(token_list.size()+token_list.get(0).getAccess_token());
    ...
    public static Token getToken2(String appid, String appsecret) {
        Token token = null;
	...
	public static void main(String[] args) {
		...
		c.getToken("wx44e9ad003c3f9940","4492ebf1221d8d3c4da87b1e1e5954c2");
	}
}