...
import com.cwh.springbootMybatis.weixin.entity.Articles;
import com.cwh.springbootMybatis.weixin.entity.Item;
import com.cwh.springbootMybatis.weixin.entity.Music;
import com.cwh.springbootMybatis.weixin.entity.ReplyMusicMessage;
import com.cwh.springbootMybatis.weixin.entity.ReplyTextMessage;
import com.cwh.springbootMybatis.weixin.entity.ReplyTuwenMessage;
...
//  获取关注事件
    public static RequestTextMessage getRequestFocus(String xml){
            ...
            xstream.aliasField("Ticket", RequestTextMessage.class, "ticket");
            xstream.aliasField("Encrypt", RequestTextMessage.class, "encrypt");
