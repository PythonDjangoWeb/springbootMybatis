...
import com.cwh.springbootMybatis.weixin.entity.SNSUserInfo;
import com.cwh.springbootMybatis.weixin.entity.WeixinGroup;
import com.cwh.springbootMybatis.weixin.entity.WeixinMedia;
import com.cwh.springbootMybatis.weixin.entity.WeixinOauth2Token;
import com.cwh.springbootMybatis.weixin.entity.WeixinQRCode;
import com.cwh.springbootMybatis.weixin.entity.WeixinUserInfo;
import com.cwh.springbootMybatis.weixin.entity.WeixinUserList;
import com.cwh.springbootMybatis.weixin.message.resq.Article;
import com.cwh.springbootMybatis.weixin.message.resq.Music;
	...
	public static SNSUserInfo getSNSUserInfo(String accessToken, String openId) {
		...
		if (null != jsonObject) {
			try {
				...
				int errorCode = jsonObject.getInt("errcode");
				String errorMsg = jsonObject.getString("errmsg");
				log.error("获取信息失败 errcode:{} errmsg:{}", errorCode, errorMsg);
			}
		}
		return snsUserInfo;
	}
